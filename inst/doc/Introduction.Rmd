...
This package implements several approaches and utilities for object orientation inside the R language. The need for this implementation was not to implement features like encapsulation or other concepts associated with object orientation in R as they are readily available in other packages (methods, R6, R.oo, proto). However, in this package class definitions are empored by non standard evaluation which contributes to the readibility and thus maintanability of your source code which is especially important in larger projects. 
